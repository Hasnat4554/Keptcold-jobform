...
export default function Step3Priority({ selectedService, onSelect, onNext, onBack }: Props) {
  const handleNext = () => {
    onNext();
  };
    ...
    <div className="bg-white rounded-lg shadow-lg p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          How quickly do you need our service?
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="p-6 bg-white">
            <div className="mb-4">
              <div className="text-4xl font-bold text-[#003366] mb-1">
                £120<span className="text-lg font-normal text-gray-600"> + VAT</span>
              </div>
            </div>
          ...
          <div className="p-6 bg-white">
            <div className="mb-4">
              <div className="text-4xl font-bold text-orange-500 mb-1">
                £180<span className="text-lg font-normal text-gray-600"> + VAT</span>
              </div>
            </div>
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
        ...
        >
          <div className="bg-red-500 text-white p-4">
            <h3 className="text-xl font-bold mb-1">Emergency 4 Hour Response</h3>
            <p className="text-sm opacity-90">4-hour Arrival</p>
          </div>
          <div className="p-6 bg-white">
            <div className="mb-4">
              <div className="text-4xl font-bold text-red-500 mb-1">
                £240<span className="text-lg font-normal text-gray-600"> + VAT</span>
              </div>
            </div>
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
